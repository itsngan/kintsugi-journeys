                ...
                {isEditing ? (
                  <div className="flex items-center gap-2 w-full mb-3">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setProfile(prev => ({ ...prev, currentIndustry: e.target.value }))}
                ...
                {isEditing ? (
                  <>
                    <Input 
                      ...
                      onChange={(e) => setProfile(prev => ({ ...prev, dreamTitle: e.target.value }))}
                      placeholder="Dream title..."
                      className="flex-1 h-8"
                    />
                    <span className="text-muted-foreground">in</span>
                    <Input 
                      value={profile.dreamIndustry}
                      onChange={(e) => setProfile(prev => ({ ...prev, dreamIndustry: e.target.value }))}
                      placeholder="Dream industry..."
                      className="flex-1 h-8"
                    />
                  </>
                ) : (
